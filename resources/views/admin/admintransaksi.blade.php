                  ...
                  <td>
                    <div class="d-flex flex-column justify-content-start">
                      <div class="d-flex justify-content-start mb-2">
                          <a href='{{ url('transaksi/'.$item->id.'/edit') }}' class="btn btn-warning btn-sm me-2">
                              Edit
                          </a>
                          ...
                          <form onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')" action="{{ url('transaksi/'.$item->id) }}" method="post">
                              @csrf
                              @method('DELETE')

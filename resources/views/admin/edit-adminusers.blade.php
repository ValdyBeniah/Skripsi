...
@endif
<form action=' {{ url('adminuser/'.$data->id) }} ' method='post'>
    @csrf
    @method('PUT')
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <a href="{{ url('adminuser') }}" class="btn btn-secondary"><< Back</a>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            <label for="pickup" class="col-sm-2 col-form-label">Email</label>
            <div class="col-sm-10">
